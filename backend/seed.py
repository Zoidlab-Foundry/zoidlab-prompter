...
TEMPLATES = [
    ("Restaurant Concierge Prompt", "Restaurant", ["restaurant", "concierge", "customer-support"], "medium",
     ...
     "{{customer_message}}",
     [_v("business_name", "string", True, "The restaurant name.", "Trattoria Esempio"),
     ...
     [("Sunday Hours", {"business_name": "Trattoria Esempio", "customer_message": "Are you open Sunday?"}, ["Sunday", "hours"], ["I do not know"])]),
